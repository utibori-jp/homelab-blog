...
![Data exchange layer X-tee](x-road-data-exchange-layer.png)
...
![X-RoadのSecurity Server間P2P構成](x-road-security-server-p2p.png)
...
前述の通り、システム化を進めたわけだが、当初は全体を統一的に設計する予算も、そうする権限を持つ組織もなかったため、1990年代を通じて、各省庁はそれぞれ独自にシステムを構築していった。たとえば法務省が所管する商業登記簿（äriregister）は1995年に稼働しており、こうした登記簿や各種業務システムが、機関ごとに別々の技術・設計で立ち上げられていった。
...
話を戻してエストニアでは、全国民にカードはいきわたったが、電子的にはほとんど使われなかった。理由は単純で、使うのが面倒だったから。カードを使うには、専用のカードリーダ及び専用のソフトウェアが必要であり、当初はそこまでして使いたい行政サービスも特になかった。実際、最初の電子署名は2002年10月にタリンとタルトゥの市長が交わした協定で行われたが、2003年に行われた電子署名は年間でわずか14,317件にとどまっていた（近年は年間1億件を超える）。
...
- 90年代の機関別システムの例：法務省所管の商業登記簿（äriregister）は1995年9月に稼働（現在はRIKが運用）。90年代から各機関が個別にシステムを立ち上げていた一例。 https://www.baltic-legal.com/commercial-register-of-estonia-eng.htm
- IDカードの初期利用：最初の電子署名は2002年10月7日（タリンとタルトゥ両市長の協定）。2003年の電子署名は年間わずか14,317件で、初期は「配ったが電子的には使われない」状態だった（近年は年間1億件超）。 https://e-estonia.com/a-digital-success-story-the-cornerstone-of-e-estonia-celebrates-its-jubilee/ 、 https://www.ria.ee/en/news/20-years-more-800-million-digital-signatures-have-been-given-estonia
